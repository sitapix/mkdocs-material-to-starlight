 ...
 *
 * The answer decides — BEFORE any file converts — whether the site emits its
 * local Material-admonition remark plugin and preserves those type names
 * verbatim. It must be a site-level decision: a per-file flag
