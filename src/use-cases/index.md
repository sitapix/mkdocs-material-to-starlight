...
This layer answers: *"How do the things in `domain/` combine to produce a converted file?"* — the conversion pipeline, the navigation compiler, the snippet expansion, the link rewriter. Every use case takes data in and returns data out.
...
- `pipeline/` — assembler: validates plugin DAG and produces an executable processor
